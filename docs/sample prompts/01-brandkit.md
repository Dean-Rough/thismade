...
# MADETHIS BRAND-KIT REQUEST

Create a premium brand-kit overview image for "shopface".
Business context:
- business name: shopface
- description: a “website before the sales pitch” service for Scottish small businesses. Find companies with weak sites, turn verified public facts into polished fictional or prospect-specific Astro previews, and let a human check every claim, image and layout before sending one private link. Previews must be unindexed, clearly unofficial, free of live forms and automatically removed after outreach expires.
Sell the accepted site as Website + Care: £39/month, with £29/month for the first ten customers, a three-month initial term and chargeable content changes. Recreate it as a contract-driven template engine with sector presets, immutable content snapshots, Vercel deployment, a small control plane, automated safety/quality checks, a public marketing site and reviewable email templates—keeping customer editing, dashboards and heavyweight automation outside the pilot.
- storefront template type: saas
- founder's original idea: a “website before the sales pitch” service for Scottish small businesses. Find companies with weak sites, turn verified public facts into polished fictional or prospect-specific Astro previews, and let a human check every claim, image and layout before sending one private link. Previews must be unindexed, clearly unofficial, free of live forms and automatically removed after outreach expires.
Sell the accepted site as Website + Care: £39/month, with £29/month for the first ten customers, a three-month initial term and chargeable content changes. Recreate it as a contract-driven template engine with sector presets, immutable content snapshots, Vercel deployment, a small control plane, automated safety/quality checks, a public marketing site and reviewable email templates—keeping customer editing, dashboards and heavyweight automation outside the pilot.
- onboarding blueprint: {"confidence":0.94,"features":["Sector-based Astro preview generator","Immutable facts and content snapshots","Human claim, image and layout review","Private expiring Vercel preview links","Website + Care billing flow"],"reasoning":"This is primarily a contract-driven SaaS production system: it generates private, time-limited Astro previews from verified public facts, routes them through human review, and converts accepted previews into recurring Website + Care subscriptions. The pilot deliberately needs a lightweight control plane and deployment automation rather than a traditional agency portal.","templateName":"Scottish Website Preview & Care Engine","upsell":"Later, add a tightly scoped client change-request portal."}
- complete onboarding/template config: {"_blueprint":{"confidence":0.94,"features":["Sector-based Astro preview generator","Immutable facts and content snapshots","Human claim, image and layout review","Private expiring Vercel preview links","Website + Care billing flow"],"reasoning":"This is primarily a contract-driven SaaS production system: it generates private, time-limited Astro previews from verified public facts, routes them through human review, and converts accepted previews into recurring Website + Care subscriptions. The pilot deliberately needs a lightweight control plane and deployment automation rather than a traditional agency portal.","templateName":"Scottish Website Preview & Care Engine","upsell":"Later, add a tightly scoped client change-request portal."},"_ideaText":"a “website before the sales pitch” service for Scottish small businesses. Find companies with weak sites, turn verified public facts into polished fictional or prospect-specific Astro previews, and let a human check every claim, image and layout before sending one private link. Previews must be unindexed, clearly unofficial, free of live forms and automatically removed after outreach expires.\nSell the accepted site as Website + Care: £39/month, with £29/month for the first ten customers, a three-month initial term and chargeable content changes. Recreate it as a contract-driven template engine with sector presets, immutable content snapshots, Vercel deployment, a small control plane, automated safety/quality checks, a public marketing site and reviewable email templates—keeping customer editing, dashboards and heavyweight automation outside the pilot.","_q_build_features":"Sector-based Astro preview generator | Immutable facts and content snapshots | Human claim, image and layout review | Private expiring Vercel preview links | Website + Care billing flow | Registry prospecting for active Scottish businesses | Website and SEO scoring triggers low-score previews | AI-automated outreach and sales pipeline","_q_pilot_sectors":"Mixed local pilot"}
- saved brand vibe: techy
- saved brand tone: bold
HARD LAYOUT CONTRACT:
- The final image MUST be a mathematically regular 3x3 contact sheet, like a tic-tac-toe board.
- Divide the full canvas into exactly 3 equal-width columns and exactly 3 equal-height rows.
- Column boundaries must sit at exactly 33.333% and 66.667% of canvas width.
- Row boundaries must sit at exactly 33.333% and 66.667% of canvas height.
- Every panel must occupy exactly one grid cell: 1/3 canvas width by 1/3 canvas height.
- All 9 cells must have identical perceived width and identical perceived height.
- Use straight vertical and horizontal divider lines only; no staggered, offset, masonry, magazine, collage, bento, or asymmetric layout.
- Do not merge panels, span panels, crop panels, make one panel larger, make a row taller/shorter, or make a column wider/narrower.
- If using gutters, treat them as thin divider lines on top of the grid. Gutters must NOT change the equal size of any row, column, or panel.
- The output should read as a precise 3x3 template first, premium brand board second.
Panel 9 / System Detail MUST include two matching app/favicon icons: a dark or colored light-mode icon for light browser/UI backgrounds, and a light or inverted dark-mode icon for dark browser/UI backgrounds. The two icons must share the same geometry, silhouette, proportions, and crop; only the contrast treatment should change.
Apply the full BrandKit skill above verbatim. Generate ONE finished brand-kit overview board, not multiple logo options.
Use sparse readable text only. The board should include a logo concept, system applications, palette, type direction, and visual world in one cohesive image.